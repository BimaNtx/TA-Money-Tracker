...
class HomeScreen extends StatefulWidget {
  ...
  const HomeScreen({super.key, required this.transactions, this.onViewAll});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // ── Smart Insight Card ────────────────────────────────
                  SmartInsightCard(transactions: selectedMonthTx.toList())
                      .animate()
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildBuilderDelegate((context, index) {
                  ...
                  return TransactionTile(transaction: displayList[index])
                      .animate()
